...
VALUES
('CALCENA','1234','DAVID','CALCENA','CASTRO',1,'01/07/2018');
...
('CLI-00002/18','CLIENTE2','UNA CUALQUIERA','08850','GRANOLLERS','BARCELONA','26/07/2018'),
('CLI-00003/18','CLIENTE3','UNA CUALQUIERA','08125','BREDA','BARCELONA','26/07/2018'),
('CLI-00004/18','CLIENTE4','UNA CUALQUIERA','08956','VALLSERENA','BARCELONA','26/07/2018'),
('CLI-00005/18','CLIENTE5','UNA CUALQUIERA','08467','COLLSUSPINA','BARCELONA','26/07/2018');
...
INSERT INTO REQUERIMIENTOS(ID_PROYECTO,COD_REQUERIMIENTO,DESCRIPCION,RUTA,VERSION,FECHA_MODIF)
VALUES
...
MOTIVO_CIERRE VARCHAR(2000) DEFAULT NULL,
FECHA_MODIF VARCHAR(19)
);
...
(1,0,2,'TAR-00002/18','Tarea de BackEnd: desarrollo de Login',180,'27/10/2018',2,'30/07/2018');
...
ID_CONFIGURACION INTEGER PRIMARY KEY AUTO_INCREMENT,
NUM_CLI INTEGER,
NUM_USU INTEGER,
NUM_PRO INTEGER,
NUM_REQ INTEGER,
...
INSERT INTO CONFIGURACIONES (NUM_CLI, NUM_USU, NUM_PRO, NUM_REQ, NUM_TAR)
VALUES
(1,1,1,1,1);
